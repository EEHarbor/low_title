...
/**
 * EEHarbor PHAR Loader for Low Title
 ...
 * @link       https://eeharbor.com/low_title
 */

spl_autoload_register(
    function ($class_name) {
        // This is the PHAR path for this addon
        $phar_path = PATH_THIRD . 'low_title/low_title.phar';
        $phar_stream_path = 'phar://' . $phar_path;
        $tmp_phar_path = sys_get_temp_dir() . '/pharextract/low_title';
